  ...
  const handleChange = (event) => {
    setformData((prevFormData) => {
      ...
      if (isSignIn) {
        ...
        if (
          updatedFormData.confirmPassword.length > 3 &&
        ...
        if (
          updatedFormData.fullName.length > 4 &&
          updatedFormData.userName.length > 4 &&
  ...
  const apicall = async (requestOptions, avatharURL) => {
    try {
      ...
      const response = await fetch(
        `${URL}/${isSignIn ? "login" : "signup"}`,
        requestOptions
      );
      const data = response.json();
      const { token, userId, fullName, userName, hashedPassword, message } =
        await data;
    ...
    <>
      <div className="auth_wrapper_main">
        ...
        <div className="project_company_name">
          <span>
            <p>
              <b style={{ color: "#1e6ffb" }}>Dr.</b>Chat
            </p>
          </span>
        </div>
          ...
          <div className="auth_wrapper_right_main">
            <div className="auth_wrapper_right_mode_switch">
              <div
                ...
                className={`auth_wrapper_right_mode_sign_in  ${
                  isSignIn ? "selected_border" : ""
                }`}
              >
                <p>Sign in</p>
              </div>
              <div
                ...
                className={`auth_wrapper_right_mode_create_account ${
                  isSignIn ? "" : "selected_border"
                }`}
              >
                <p>Create Account</p>
            ...
            <h6 className="auth_wrapper_right_form_title">
              {" "}
              {isSignIn
            ...
            <form onSubmit={handleSubmit}>
              ...
              <div className="auth_wrapper_right_form_input">
                <input
                  ...
                  ref={userNameRef}
                  onKeyDown={(e) =>
                    handleKeyDown(e, isSignIn ? passwordRef : avatharRef)
                  }
                  className="formAnimInput"
                  placeholder=" "
                  name="userName"
              ...
              {/* {!isSignIn && (
                <div className="auth_wrapper_right_form_input">
                  ...
                  />
                  <label className="formLabel" htmlFor="avatharUrl">
                    Avathar URL
                  </label>
                </div>
              )} */}
              <div className="auth_wrapper_right_form_input">
                <input
                  ref={passwordRef}
                  onKeyDown={(e) =>
                    handleKeyDown(e, isSignIn ? "" : confirmPasswordRef)
                  }
                  type="password"
                  className="formAnimInput"
                  placeholder=" "
              ...
              {!isSignIn && (
                <>
                  ...
                  <div className="show_password_incorrect">
                    {showPasswordIncorrect && <p>Passwords not match</p>}
                  </div>
                </>
              )}
              <div
                onClick={handleSubmit}
                className={`auth_wrapper_right_form_button  ${
                  disableSubmitBtn ? "disable_submit_button" : ""
                }`}
              >
          ...
          <div className="auth_wrapper_right_footer">
            {isSignIn ? (
              <p>
                ...
                <b onClick={() => switchMode("signUp")}>Create Account</b>
              </p>
            ) : (
              <p
                className="auth_wrapper_right_footer_2ndP"
                onClick={() => switchMode("signIn")}
              >
